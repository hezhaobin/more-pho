...
author: Bin He
date: "3 aout 2022 (updated `r format(Sys.time(), '%m/%d/%y')`)"
output:
  html_notebook:
    toc: true
    toc_depth: 4
...
data.path = "/Volumes/rdss_bhe2/Project/E013-Pho4p-evolution/flow-cytometry/data/20220803-EO-region-4.2-repeat/"
