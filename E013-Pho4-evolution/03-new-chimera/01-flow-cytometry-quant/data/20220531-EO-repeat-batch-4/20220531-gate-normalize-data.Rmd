...
data.path = "/Volumes/rdss_bhe2/Project/E013-Pho4p-evolution/flow-cytometry/data/20220531-EO-chimera-no-mutation-4/"
...
```{r}
sample <- read.csv("20220531-sample-list.csv") %>% 
...
```{r}
list.redo <- paste(rep(c("218", "231", "233"), each = 3), "555", 1:3, sep = "-")
...
write_tsv(final, "20220531-gated-median-out.txt")
```
