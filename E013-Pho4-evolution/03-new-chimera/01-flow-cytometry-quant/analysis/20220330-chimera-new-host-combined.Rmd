...
dat1 <- dat %>% 
  ...
  mutate(host = factor(host, levels = c("373", "555"), labels = c("pho2∆", "PHO2")))
```
...
> The host strain fluorescence levels appear consistent across the three days. Additionally, their GFP levels are zero, as expected. RFP levels appear to be slightly higher in the _pho2∆_ background than in the _PHO2_ background.
