...
```{r}
data.path = "../../data/FCS/20211217-correct-well-positions-2/"
...
names <- sampleNames(fs) %>% gsub("Correct well position effects #2_Experiment_Plate_", "", .) %>% gsub(".fcs","",.)
...
write_tsv(final, "20211217-gated-median-out.txt")
```
